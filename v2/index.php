       ...
       <div class="item">
         <div class="container">
             ...
             <div class="col-md-6 article-box">
                 ...
                 <p class="article-link"><a href="http://www.eclipse.org/paho/v2/articles/talkingsmall/">Talking Small: Using Eclipse Paho's MQTT on BeagleBone Black and Raspberry Pi &raquo;</a></p>
             </div>
...
<div class="jumbotron mqtt-row">
  <div class="container">
      <div class="row">
          ...
          <div class="col-md-4">
            <div class="span3" style="padding-top: 100px;"><img src="/paho/v2/images/mqttorg-glow.png" /></div>
          </div>
      </div>
  </div>
</div>
