...
<div class="jumbotron home_banner">
    <div class="container text-center">
        <div class="logoandtext">
            <img class="img-responsive logo_image" src="/paho/v2/images/paho_logo_400.png" tite="Eclipse Paho Logo" alt="<Logo>" />
        </div>
        ...
        <p><a class="btn btn-primary btn-lg" href="/paho/v2/downloads.php" role="button">Download Now &raquo;</a>
        </p>
    </div>
</div>
<!-- **************** -->
            ...
            <div class="item active">
                <div class="container ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h2><i><img src="/paho/v2/images/chip.png"></i></h2>
                            <div>
                                <h2>&nbsp;</h2>
                            </div>
                        ...
                        <div class="col-md-4">
                            <h2><i><img src="/paho/v2/images/scale.png"></i></h2>
                            <div>
                                <h2>&nbsp;</h2>
                            </div>
            ...
            <div class="item">
                <div class="container">
                    ...
                    <div class="col-md-6 article-box">
                        ...
                        <p class="article-link"><a href="http://www.eclipse.org/paho/v2/articles/talkingsmall/">Talking Small: Using Eclipse Paho's MQTT on BeagleBone Black and Raspberry Pi &raquo;</a>
                        </p>
                    </div>
...
<div class="mqtt-row">
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-4">
                <div class="span3" style="padding-top: 100px;"><img src="/paho/v2/images/mqttorg-glow.png" />
                </div>
            </div>
