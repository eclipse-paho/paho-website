...
<html lang="en">
    ...
    <![endif]-->
        ...
        <link rel="shortcut icon" href="/paho/v2/images/favicon.png">
        <link href="/paho/v2/css/bootstrap.min.css" rel="stylesheet" type='text/css'>
        <link href="/paho/v2/css/style.css" rel="stylesheet" type='text/css'><!-- HTML5 shim, for IE6-8 support of HTML elements -->
        <!--[if lt IE 9]>
            <script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
            <![endif]-->
        <!-- Custom Fonts -->
            ...
            <ul class="nav navbar-nav">
                          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Components <b class="caret"></b></a>
                              <ul class="dropdown-menu" role="menu">
                                  ...
                                  <li><a href="/paho/v2/clients/dotnet/">C# .Net and WinRT</a></li>
                                  ...
                                  <li><a href="/paho/v2/clients/android/sample">Android Sample</a></li>
                                  <!-- <li><a href="/paho/v2/utilities/client-view/">MQTT Eclipse Client View (IDE plugin)</a></li> -->
                                  <!-- <li><a href="/paho/v2/utilities/client-utility/">MQTT Client Utility (java)</a></li> -->
                                  <li><a href="/paho/v2/clients/testing/">Interop Tests</a></li>
                              </ul>
                          </li>
                          <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Documentation <b class="caret"></b></a>
                              <ul class="dropdown-menu">
                                <li><a href="/paho/v2/#getting-started">Getting Started</a></li>
                                <li><a href="/paho/v2/#contributing">Contributing</a></li>
                                <li><a href="/paho/v2/#mqtt">About MQTT</a></li>
                                <li><a href="/paho/v2/#articles">Featured Articles</a></li>
                                <li><a href="http://wiki.eclipse.org/Paho">Project Wiki</a></li>
                                <li><a href="/paho/v2/branding">Branding</a></li>
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="/paho/v2/whoisusing/">Stories</a></li>
